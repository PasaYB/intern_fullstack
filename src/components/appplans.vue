<template>
  <section id="plans" class="pb-8">
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 bebas-neue-regular mt-9">My Future Plans</h1>
            ...
            <v-row class="text-center">
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="border1">
                          <v-img src="~@/assets/img/work.png"/>
                        </div>
                      </div>
                    <div class="lexend my-2">Work at my dream company</div>
                  </v-card-text>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="border1">
                          <v-img src="~@/assets/img/buss.png"/>
                        </div>
                      </div>
                    <div class="lexend my-2">Build my own business</div>
                  </v-card-text>
                  <v-divider style="margin-right: -23px" vertical v-if="this.$vuetify.breakpoint.mdAndUp"></v-divider>
                </div>
                <v-divider class="mx-4" v-if="!this.$vuetify.breakpoint.smAndUp"></v-divider>
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                          <v-img src="~@/assets/img/poce.png"/>
                        </div>
                    <div class="lexend my-2">Buy Porsche</div>
                  </v-card-text>
                </div>
              </v-col>
            </v-row>
